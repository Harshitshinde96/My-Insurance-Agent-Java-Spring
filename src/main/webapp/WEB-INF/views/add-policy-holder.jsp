...
<body>
    ...
    <div class="container">
        ...
        <form action="submitAddPolicyHolder" method="post">
            <div class="form-group">
                <label for="phEmail">Email:</label>
                <input type="email" name="phEmail" id="phEmail" required>
            </div>

            <div class="form-group">
                <label for="phName">Full Name:</label>
                <input type="text" name="phName" id="phName" required>
            </div>

            <div class="form-group">
                <label for="phDob">Date of Birth:</label>
                <input type="date" name="phDob" id="phDob" required>
            </div>

            <div class="form-group">
                <label for="phContact">Contact Number:</label>
                <input type="text" name="phContact" id="phContact" required>
            </div>

            <div class="form-group">
                <label for="phAddress">Address:</label>
                <textarea name="phAddress" id="phAddress" rows="3" required></textarea>
            </div>

            <div class="form-group">
                <label for="phPassword">Password:</label>
                <input type="password" name="phPassword" id="phPassword" required>
            </div>

            <button type="submit" class="btn-submit">Add Policy Holder</button>
        </form>
