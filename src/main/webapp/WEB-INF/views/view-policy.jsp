        ...
        <div class="table-container">
            <table id="policiesTable">
                ...
                <tbody>
                    ...
                    %>
                    <tr class="<%= rowClass %>" 
                        data-expiry="<%= isNearExpiry ? "near" : isExpired ? "expired" : "other" %>">
                        <td><%=policy.getPolicyId()%></td>
                        <td><%=policy.getPolicyTitle()%></td>
                        <td><%=policy.getPhName()%></td>
                        ...
                        <td>
                            <a href="updateDueDatePage?pid=<%= policy.getPolicyId()%>" class="action-btn update-btn">
                                <i class="fas fa-calendar-alt"></i> Update
                            </a>
                        </td>
                    </tr>
                    <%
