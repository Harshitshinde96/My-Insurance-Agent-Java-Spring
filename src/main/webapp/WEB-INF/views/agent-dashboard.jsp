...
<head>
<meta charset="UTF-8">
<title>Agent Dashboard - My Insurance Agent</title>
  ...
  <div class="dashboard-wrapper">
    ...
    <aside class="sidebar">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item">
          <a href="/MyInsuranceAgent/agent/addPolicyHolder" class="nav-link">
            <i class="fas fa-user-plus"></i>
            <span>Add Policy Holder</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="/MyInsuranceAgent/agent/managePolicyHolder" class="nav-link">
            <i class="fas fa-users-cog"></i>
            <span>Manage Policy Holders</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="/MyInsuranceAgent/agent/addPolicyPage" class="nav-link">
            <i class="fas fa-file-contract"></i>
            <span>Add Policy</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="/MyInsuranceAgent/agent/viewPolicyDetails" class="nav-link">
    ...
    <main class="main-content">
      <div class="top-nav">
        ...
        <div class="user-menu">
          <div class="user-info">
            <div class="user-name">Agent User</div>
      ...
      <div class="card-grid">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Policy Holders</div>
            <div class="card-icon">
              <i class="fas fa-users"></i>
            </div>
          </div>
          <div class="card-value">87</div>
          <div class="card-description">+5 this month</div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-description">+8 this week</div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-description">3 awaiting approval</div>
        </div>
      ...
      <div class="quick-actions">
        <a href="/MyInsuranceAgent/agent/addPolicyHolder" class="action-btn">
          <i class="fas fa-user-plus"></i>
          Add Policy Holder
        </a>
        
        <a href="/MyInsuranceAgent/agent/managePolicyHolder" class="action-btn">
          <i class="fas fa-users-cog"></i>
          Manage Policy Holders
        </a>
        
        <a href="/MyInsuranceAgent/agent/addPolicyPage" class="action-btn">
          <i class="fas fa-file-contract"></i>
          Create New Policy
        </a>
        
        <a href="/MyInsuranceAgent/agent/viewPolicyDetails" class="action-btn">
